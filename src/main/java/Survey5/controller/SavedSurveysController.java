...
public class SavedSurveysController{
    ...
    private void switchTemplate(Survey survey){
        switch (survey.getTypeOfTemplate()){
            ...
            case "SportsTemplate1": {
                SportsTemplate1Controller.setData(userdata);
                SportsTemplate1Controller.setCreateOrAnswerFunction("ShowAnswer",survey);
                break;
            }
            ...
            case "SportsTemplate4": {
                ...
                SportsTemplate4Controller.setCreateOrAnswerFunction("ShowAnswer",survey);
                break;
            }
