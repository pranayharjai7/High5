...
public class SportsTemplate3Controller {
    ...
    @FXML
    private AnchorPane SportsTemplate3AnchorPane;
    @FXML
    private Label SportsTemplate3;
    @FXML
    ...
    private void saveButtonClicked(ActionEvent event){
        ...
        survey.setTypeOfTemplate(SportsTemplate3.getId());
        survey.setTitle(SportsTemplate3.getText());
