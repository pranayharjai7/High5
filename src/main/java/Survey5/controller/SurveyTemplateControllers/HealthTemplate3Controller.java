...
public class HealthTemplate3Controller
{
    ...
    private boolean setRadioButtons(){
        if(answer1.getSelectedToggle()==null||answer2.getSelectedToggle()==null||answer3.getSelectedToggle()==null||
                ...
                answer10.getSelectedToggle()==null){
            return false;
        }
        else{
