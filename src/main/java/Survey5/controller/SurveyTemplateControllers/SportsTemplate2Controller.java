...
public class SportsTemplate2Controller {
    ...
    private void saveButtonClicked(ActionEvent event){
        ...
        survey.setTypeOfTemplate(SportsTemplate2.getId());
        survey.setTitle(SportsTemplate2.getText());
