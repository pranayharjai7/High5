...
public class BusinessTemplate2ControllerTest {

    private BusinessTemplate2Controller b1ctrl;
   ...
   /* @AfterAll
    public static void tearDownClass() throws Exception {
        ...
        FXMLLoader loader = new FXMLLoader(NewSurveyController.class.getResource("/fxml/SurveyTemplates/BusinessTemplate2.fxml"));

        Scene scene = new Scene(loader.load());
        b1ctrl = loader.<BusinessTemplate2Controller>getController();
        //b1ctrl = loader.<BusinessTemplate2Controller>getController();*/
    ...
    /**
     * Test of setData method, of class BusinessTemplate2Controller.
     */
    ...
    public void SaveButtonest(FxRobot robot) {
        ...
        public void run(){  
            try {
                ...
                BusinessTemplate2Controller.setData(dtest_sb);
                b1ctrl.initialize();
                ...
                Logger.getLogger(BusinessTemplate2ControllerTest.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public void testAnswerButt_whenAnsweredBefore(FxRobot robot) {
        ...
        public void run(){   
            ...
            try {
                ...
                BusinessTemplate2Controller.setCreateOrAnswerFunction("answer", surTest);
                BusinessTemplate1Controller.setData(dtest);
                b1ctrl.initialize();
                b1ctrl.submitButtonClicked(aeMock);
                
                assertNotNull(BusinessTemplate2Controller.getAnswer());
    ...
    public void testAnswerButt_whenNot_AnsweredBefore(FxRobot robot) {
        ...
        public void run(){   
            ...
            try {
                ...
                BusinessTemplate2Controller.setCreateOrAnswerFunction("answer", surTest_ab);
                BusinessTemplate2Controller.setData(dtest_ab2);
                b1ctrl.initialize();
                b1ctrl.submitButtonClicked(aeMock);
    ...
    public void testAnswerButt_when_SurveyEmpty(FxRobot robot) {
        ...
        public void run(){   
            ...
            try {
                ...
                BusinessTemplate2Controller.setCreateOrAnswerFunction("answer", surTest_se);
                BusinessTemplate2Controller.setData(dtest_se2);
                b1ctrl.initialize();
    ...
    public void ShowAnsButtonTest(FxRobot robot) {
        ...
        public void run(){  
            try {
                ...
                BusinessTemplate2Controller.setCreateOrAnswerFunction("ShowAnswer",surTest_sha);
                BusinessTemplate2Controller.setData(dtest_sha);
                b1ctrl.initialize();
