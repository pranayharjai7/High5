...
public class BusinessTemplate4ControllerTest {
    @Mock private MainApp mainMock;
    private BusinessTemplate4Controller b1ctrl;
   ...
   /* @AfterAll
    public static void tearDownClass() throws Exception {
        ...
        FXMLLoader loader = new FXMLLoader(NewSurveyController.class.getResource("/fxml/SurveyTemplates/BusinessTemplate4.fxml"));

        Scene scene = new Scene(loader.load(), 800, 800);
        b1ctrl = loader.<BusinessTemplate4Controller>getController();
        //b1ctrl = loader.<BusinessTemplate4Controller>getController();*/
    ...
    public void SaveButtonest(FxRobot robot) {
        ...
        public void run(){  
            try {
                ...
                BusinessTemplate4Controller.setData(dtest_sb);
                b1ctrl.initialize();
                ...
                Logger.getLogger(BusinessTemplate4ControllerTest.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public void testAnswerButt_whenAnsweredBefore(FxRobot robot) {
        ...
        public void run(){   
            ...
            try {
                ...
                BusinessTemplate4Controller.setCreateOrAnswerFunction("answer", surTest);
                BusinessTemplate4Controller.setData(dtest);
                b1ctrl.initialize();
                b1ctrl.submitButtonClicked(aeMock);
                
                assertNotNull(BusinessTemplate4Controller.getAnswer());
    ...
    public void testAnswerButt_whenNot_AnsweredBefore(FxRobot robot) {
        ...
        public void run(){   
            ...
            try {
                ...
                BusinessTemplate4Controller.setCreateOrAnswerFunction("answer", surTest_ab);
                BusinessTemplate4Controller.setData(dtest_ab2);
                b1ctrl.initialize();
                b1ctrl.submitButtonClicked(aeMock);
    ...
    public void testAnswerButt_when_SurveyEmpty(FxRobot robot) {
        ...
        public void run(){   
            ...
            try {
                ...
                BusinessTemplate4Controller.setCreateOrAnswerFunction("answer", surTest_se);
                BusinessTemplate4Controller.setData(dtest_se2);
                b1ctrl.initialize();
    ...
    public void ShowAnsButtonTest(FxRobot robot) {
        ...
        public void run(){  
            try {
                ...
                BusinessTemplate4Controller.setCreateOrAnswerFunction("ShowAnswer",surTest_sha);
                BusinessTemplate4Controller.setData(dtest_sha);
                b1ctrl.initialize();
