...
public class FoodTemplate3ControllerTest {
    @Mock private MainApp mainMock;
    private FoodTemplate3Controller b1ctrl;
   ...
   /* @AfterAll
    public static void tearDownClass() throws Exception {
        ...
        FXMLLoader loader = new FXMLLoader(NewSurveyController.class.getResource("/fxml/SurveyTemplates/FoodTemplate3.fxml"));

        Scene scene = new Scene(loader.load(), 800, 800);
        b1ctrl = loader.<FoodTemplate3Controller>getController();
        //b1ctrl = loader.<FoodTemplate3Controller>getController();*/
    ...
    public void SaveButtonest(FxRobot robot) {
        ...
        public void run(){  
            try {
                ...
                FoodTemplate3Controller.setData(dtest_sb);
                b1ctrl.initialize();
                ...
                Logger.getLogger(FoodTemplate3ControllerTest.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public void testAnswerButt_whenAnsweredBefore(FxRobot robot) {
        ...
        public void run(){   
            ...
            try {
                ...
                FoodTemplate3Controller.setCreateOrAnswerFunction("answer", surTest);
                FoodTemplate3Controller.setData(dtest);
                b1ctrl.initialize();
                b1ctrl.submitButtonClicked(aeMock);
                
                assertNotNull(FoodTemplate3Controller.getAnswer());
    ...
    public void testAnswerButt_whenNot_AnsweredBefore(FxRobot robot) {
        ...
        public void run(){   
            ...
            try {
                ...
                FoodTemplate3Controller.setCreateOrAnswerFunction("answer", surTest_ab);
                FoodTemplate3Controller.setData(dtest_ab2);
                b1ctrl.initialize();
                b1ctrl.submitButtonClicked(aeMock);
    ...
    public void testAnswerButt_when_SurveyEmpty(FxRobot robot) {
        ...
        public void run(){   
            ...
            try {
                ...
                FoodTemplate3Controller.setCreateOrAnswerFunction("answer", surTest_se);
                FoodTemplate3Controller.setData(dtest_se2);
                b1ctrl.initialize();
    ...
    public void ShowAnsButtonTest(FxRobot robot) {
        ...
        public void run(){  
            try {
                ...
                FoodTemplate3Controller.setCreateOrAnswerFunction("ShowAnswer",surTest_sha);
                FoodTemplate3Controller.setData(dtest_sha);
                b1ctrl.initialize();
                ...
                Logger.getLogger(FoodTemplate3Controller.class.getName()).log(Level.SEVERE, null, ex);
            }
