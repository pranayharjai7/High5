...
public class HealthTemplate4ControllerTest {
    @Mock private MainApp mainMock;
    private HealthTemplate4Controller b1ctrl;
   ...
   /* @AfterAll
    public static void tearDownClass() throws Exception {
        ...
        FXMLLoader loader = new FXMLLoader(NewSurveyController.class.getResource("/fxml/SurveyTemplates/HealthTemplate4.fxml"));

        Scene scene = new Scene(loader.load(), 800, 800);
        b1ctrl = loader.<HealthTemplate4Controller>getController();
    ...
    public void SaveButtonest(FxRobot robot) {
        ...
        public void run(){  
            try {
                ...
                HealthTemplate4Controller.setData(dtest_sb);
                b1ctrl.initialize();
                ...
                Logger.getLogger(HealthTemplate4ControllerTest.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public void testAnswerButt_whenAnsweredBefore(FxRobot robot) {
        ...
        public void run(){   
            ...
            try {
                ...
                HealthTemplate4Controller.setCreateOrAnswerFunction("answer", surTest);
                HealthTemplate4Controller.setData(dtest);
                b1ctrl.initialize();
                b1ctrl.submitButtonClicked(aeMock);
                
                assertNotNull(HealthTemplate4Controller.getAnswer());
    ...
    public void testAnswerButt_whenNot_AnsweredBefore(FxRobot robot) {
        ...
        public void run(){   
            ...
            try {
                ...
                HealthTemplate4Controller.setCreateOrAnswerFunction("answer", surTest_ab);
                HealthTemplate4Controller.setData(dtest_ab2);
                b1ctrl.initialize();
                b1ctrl.submitButtonClicked(aeMock);
    ...
    public void testAnswerButt_when_SurveyEmpty(FxRobot robot) {
        ...
        public void run(){   
            ...
            try {
                ...
                HealthTemplate4Controller.setCreateOrAnswerFunction("answer", surTest_se);
                HealthTemplate4Controller.setData(dtest_se2);
                b1ctrl.initialize();
    ...
    public void ShowAnsButtonTest(FxRobot robot) {
        ...
        public void run(){  
            try {
                ...
                HealthTemplate4Controller.setCreateOrAnswerFunction("ShowAnswer",surTest_sha);
                HealthTemplate4Controller.setData(dtest_sha);
                b1ctrl.initialize();
                ...
                Logger.getLogger(HealthTemplate4Controller.class.getName()).log(Level.SEVERE, null, ex);
            }
